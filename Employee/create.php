        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p><em>Please fill this form and submit to add employee record to the database.</em></p>
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="form-group <?php echo (!empty($salary_err)) ? 'has-error' : ''; ?>">
                            ...
                            <input type="text" name="salary" class="form-control" placeholder="RM" value="<?php echo $salary; ?>">
